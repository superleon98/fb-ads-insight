...
import type { FeishuUser } from '../types';
 ...
 */
export async function exchangeFeishuCode(code: string): Promise<FeishuUser> {
 ...
 * 创建用户会话
 */
export function createSession(user: FeishuUser): string {
 ...
 * 验证会话
 */
export function verifySession(token: string): FeishuUser | null {
